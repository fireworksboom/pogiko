 ...
 */
function wp5default_custom_colors_css() {
	...
	/**
	 * Filter WP5 Default default saturation level.
	 *
	 * @since WP5 Default 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'wp5default_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter WP5 Default default selection saturation level.
	 *
	 * @since WP5 Default 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'wp5default_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter WP5 Default default lightness level.
	 *
	 * @since WP5 Default 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'wp5default_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter WP5 Default default hover lightness level.
	 *
	 * @since WP5 Default 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'wp5default_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter WP5 Default default selection lightness level.
	 *
	 * @since WP5 Default 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'wp5default_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters WP5 Default custom colors CSS.
	 *
	 * @since WP5 Default 1.0
	 *
	 ...
	 */
	return apply_filters( 'wp5default_custom_colors_css', $theme_css, $primary_color, $saturation );
}
