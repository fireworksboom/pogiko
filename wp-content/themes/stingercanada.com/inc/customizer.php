...
function wp5default_customize_register( $wp_customize ) {
	...
	// techno logo
	$wp_customize->add_setting( 'techno', array( 'default' => null ) );
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'techno', array(
		'label'		=> __( 'Technodream Logo', 'wp5default' ),
	...
	// 	'title'			=> __( 'Page Links', 'wp5default' ),
	// 	// 'description'	=> 'Adjust the display of general options on your website.',
	// 	'panel' 		=> 'theme_options',
	// 	'priority'		=> 30,
	// ) );
	...
	// 	'capability' => 'edit_theme_options',
	// 	'sanitize_callback' => 'wp5default_sanitize_dropdown_pages'
	// ) );
