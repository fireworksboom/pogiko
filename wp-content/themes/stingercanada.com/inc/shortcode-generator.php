...
function wp5default_shortcode_generator_enqueue_scripts() {
	...
	wp_register_script( 'wp5default-fontawesome-iconpicker', get_template_directory_uri() .'/assets/js/fontawesome-iconpicker.min.js', array('jquery'),'', true  );
	...
	if ( 'appearance_page_wp5default_shortcode_generator' == get_current_screen()->id ) {
		...
		wp_enqueue_script( 'wp5default-fontawesome-iconpicker' );
		...
		wp_enqueue_style( 'wp5default-font-awesome', get_template_directory_uri() . '/assets/css/font-awesome4.min.css');
		// wp_enqueue_style( 'wp5default-font-awesome', get_template_directory_uri() . '/assets/css/font-awesome.min.css' );
		wp_enqueue_style( 'wp5default-bootstrao-iso', get_template_directory_uri() .'/assets/css/bootstrap-iso.css' );
		wp_enqueue_style( 'wp5default-fontawesome-iconpicker', get_template_directory_uri() .'/assets/css/fontawesome-iconpicker.min.css' );
